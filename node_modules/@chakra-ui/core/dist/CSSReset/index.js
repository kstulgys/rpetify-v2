...
var CSSReset = function CSSReset(_ref) {
  ...
  var customFunc = config || defaultConfig;

  var configCSS = function configCSS(theme) {
    var _customFunc$colorMode = customFunc(theme)[colorMode],
        color = _customFunc$colorMode.color,
        bg = _customFunc$colorMode.bg,
        borderColor = _customFunc$colorMode.borderColor,
        placeholderColor = _customFunc$colorMode.placeholderColor;
